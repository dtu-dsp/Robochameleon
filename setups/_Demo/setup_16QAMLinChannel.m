% 16QAM setup with transmission over a linear channel, with realistic
% impairments
%
...
% DSP chain
%
classdef setup_16QAMLinChannel < module
    ...
    methods
        function obj = setup_16QAMLinChannel(param)
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Constructors
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            ...
            % CHANNEL
            linch = LinChBulk_v1(param.channel);
            ...
            iq.connectOutput(linch,1,1);
            
            % CHANNEL
            linch.connectOutputs(snr, 1);
            snr.connectOutput(cfe,1,1);
